...
import com.appshop.back_shop.dto.request.comment.CommentRequest;
...
public class CommentController {
    ...
    public ResponseEntity<String> addComment(@PathVariable Long productId,
        ...
        try {
            ...
            commentService.addComment(productId, commentRequest.getContent(), commentRequest.getRating(), commentRequest.getImageUrls());
